...
const Portfolio = () => {
  ...
  const myProjects = [
    ...
    },
    {
      ...
      projectDescription:
        "Built with HTML, TailwindCSS, JS, React, Gsap, Swiper JS. it is HIghly cinematic Animated website showing My skills in Frontend Development. Images are created by Gemini AI according to my neeed",
